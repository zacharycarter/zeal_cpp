#ifndef ZEAL_VECTOR2_H_HEADER_GUARD
#define ZEAL_VECTOR2_H_HEADER_GUARD
...
inline f32 length_squared(const Vector2 &a) { return dot(a, a); }

/// Returns the length of @a a.
inline f32 length(const Vector2 &a) { return fsqrt(length_squared(a)); }
...
/// Returns a vector that contains the largest value for each element from @a a
/// and @a b.
...
/// Returns a vector that contains the smallest value for each element from @a a
/// and @a b.
...
/// Returns the linearly interpolated vector between @a a and @a b at time @a t
/// in [0, 1].
...
inline f32 *to_float_ptr(Vector2 &a) { return &a.x; }

/// Returns the pointer to the data of @a a.
inline const f32 *to_float_ptr(const Vector2 &a) { return &a.x; }

/// @}

} // namespace zeal

#endif // ZEAL_VECTOR2_H_HEADER_GUARD