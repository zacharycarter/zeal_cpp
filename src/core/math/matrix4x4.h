#ifndef ZEAL_MATRIX4X4_H_HEADER_GUARD
#define ZEAL_MATRIX4X4_H_HEADER_GUARD
...
inline Matrix4x4 matrix4x4(f32 xx, f32 xy, f32 xz, f32 xw, f32 yx, f32 yy, f32 yz, f32 yw, f32 zx, f32 zy, f32 zz, f32 zw, f32 tx, f32 ty, f32 tz, f32 tw)
{
    Matrix4x4 m;
    m.x.x = xx;
    m.x.y = xy;
...
#endif // ZEAL_MATRIX4X4_H_HEADER_GUARD