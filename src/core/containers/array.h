#ifndef ZEAL_ARRAY_H_HEADER_GUARD
#define ZEAL_ARRAY_H_HEADER_GUARD
...
template <typename T>
inline u32 size(const Array<T> &a) { return a._size; }
...
template <typename T>
inline void condense(Array<T> &a) { resize(a, a._size); }
...
template <typename T>
inline void clear(Array<T> &a) { a._size = 0; }
...
#endif // ZEAL_ARRAY_H_HEADER_GUARD