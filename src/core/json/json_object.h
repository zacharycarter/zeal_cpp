#ifndef ZEAL_JSON_OBJECT_H_HEADER_GUARD
#define ZEAL_JSON_OBJECT_H_HEADER_GUARD
...
inline u32 size(const JsonObject &jo) { return map::size(jo._map); }
...
inline JsonObject::JsonObject(Allocator &a) : _map(a) {}
...
#endif // ZEAL_JSON_OBJECT_H_HEADER_GUARD