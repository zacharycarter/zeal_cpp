#ifndef ZEAL_DYNAMIC_STRING_H_HEADER_GUARD
#define ZEAL_DYNAMIC_STRING_H_HEADER_GUARD
...
inline DynamicString::DynamicString(Allocator &a) : _data(a) {}
...
inline void DynamicString::reserve(u32 n) { array::reserve(_data, n); }

inline u32 DynamicString::length() const { return strlen32(c_str()); }

inline bool DynamicString::empty() const { return length() == 0; }
...
#endif // ZEAL_DYNAMIC_STRING_H_HEADER_GUARD