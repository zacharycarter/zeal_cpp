#ifndef ZEAL_STRING_STREAM_H_HEADER_GUARD
#define ZEAL_STRING_STREAM_H_HEADER_GUARD
...
template <typename T>
StringStream &stream_printf(StringStream &s, const char *format, T &val);
...
#endif // ZEAL_STRING_STREAM_H_HEADER_GUARD