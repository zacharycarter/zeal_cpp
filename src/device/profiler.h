#ifndef ZEAL_PROFILER_H_HEADER_GUARD
#define ZEAL_PROFILER_H_HEADER_GUARD
...
#else
#define ENTER_PROFILE_SCOPE(name) ZE_NOOP()
#define LEAVE_PROFILE_SCOPE() ZE_NOOP()
#define RECORD_FLOAT(name, value) ZE_NOOP()
