...
void compile(CompileOptions &opts)
{
    ...
    DATA_COMPILER_ASSERT(boot_script_json != NULL, opts,
                         "'boot_script' must be specified.");
    DATA_COMPILER_ASSERT(boot_package_json != NULL, opts,
                         "'boot_package' must be specified.");
...
void unload(Allocator &a, void *resource) { a.deallocate(resource); }
