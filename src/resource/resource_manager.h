#ifndef ZEAL_RESOURCE_MANAGER_H_HEADER_GUARD
#define ZEAL_RESOURCE_MANAGER_H_HEADER_GUARD
...
struct ResourceManager
{
    ...
    /// @note The user has to manually update all the references to the old
    /// resource.
    ...
    void register_type(StringId64 type, u32 version, LoadFunction load,
                       UnloadFunction unload, OnlineFunction online,
                       OfflineFunction offline);
};

} // namespace zeal

#endif // ZEAL_RESOURCE_MANAGER_H_HEADER_GUARD